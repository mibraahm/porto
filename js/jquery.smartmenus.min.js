      ...
      t(document).bind(
        s(
          [
            ...
            [
              n ? "touchstart" : "pointerover pointermove pointerout MSPointerOver MSPointerMove MSPointerOut",
              function (t) {
      ...
      prototype: {
        init: function (e) {
          ...
          if (!e) {
            ...
            this.$root
              ...
              t(window).bind(s([["resize orientationchange", t.proxy(this.winResize, this)]], r)),
            ...
            this.$root.find("a").each(function () {
              ...
              (i == u || i == l) &&
                ...
                a.opts.markCurrentTree &&
                  e.parentsUntil("[data-smartmenus-id]", "ul").each(function () {
        ...
        destroy: function (i) {
          ...
          this.$root
            ...
            i || ((this.$root = null), (this.$firstLink = null), (this.$firstSub = null), this.$disableOverlay && (this.$disableOverlay.remove(), (this.$disableOverlay = null)), o.splice(t.inArray(this, o), 1));
        },
        disable: function (i) {
          if (!this.disabled) {
        ...
        itemActivate: function (i, e) {
          ...
          if (
            ((!this.isCollapsible() || e) && this.menuHideSubMenus(this.activatedItems[o - 1] && this.activatedItems[o - 1][0] == i[0] ? o : o - 1), (this.activatedItems[o - 1] = i), this.$root.triggerHandler("activate.smapi", i[0]) !== !1)
          ) {
            var r = i.dataSM("sub");
        ...
        menuPosition: function (i) {
          ...
          if ((T ? ((e = $ ? f - l - y : y), (o = this.opts.bottomToTopSubMenus ? -c - I : v + I)) : ((e = $ ? y - l : f - y), (o = this.opts.bottomToTopSubMenus ? v - I - c : I)), this.opts.keepInViewport)) {
            var x = m + e,
              C = p + o;
            if (
              ($ && S > x ? (e = T ? S - x + e : f - y) : !$ && x + l > S + M && (e = T ? S + M - l - x + e : y - l),
              T || (w > c && C + c > g + w ? (o += g + w - c - C) : (c >= w || g > C) && (o += g - C)),
                  ...
                  i
                    ...
                    .bind(
                      s(
                        [
                          [
                            n ? "touchstart touchmove touchend" : "pointerdown pointermove pointerup MSPointerDown MSPointerMove MSPointerUp",
                            function (t) {
        ...
        menuScroll: function (t, i, e) {
          ...
          if (
            (this.activatedItems[h - 1] && this.activatedItems[h - 1].dataSM("sub") && this.activatedItems[h - 1].dataSM("sub").is(":visible") && this.menuHideSubMenus(h - 1),
            ...
            r && ((o.up && o.y > o.downEnd) || (!o.up && o.y < o.upEnd)) && a.eq(o.up ? 1 : 0).show(),
            o.y == n)
          )
        ...
        menuScrollMousewheel: function (t, i) {
          if (this.getClosestMenu(i.target) == t[0]) {
            ...
            t
              .dataSM("scroll-arrows")
              .eq(e ? 0 : 1)
              .is(":visible") && ((t.dataSM("scroll").up = e), this.menuScroll(t, !0));
          }
          i.preventDefault();
        },
        menuScrollOut: function (i, e) {
          r &&
            (/^scroll-(up|down)/.test((e.relatedTarget || "").className) ||
              ((i[0] == e.relatedTarget || t.contains(i[0], e.relatedTarget)) && this.getClosestMenu(e.relatedTarget) == i[0]) ||
          ...
          if (((s = s.originalEvent), e(s))) {
            ...
            if (this.getClosestMenu(o.target) == i[0]) {
              ...
              if (/(start|down)$/i.test(s.type))
                this.menuScrollStop(i) ? (s.preventDefault(), (this.$touchScrollingSub = i)) : (this.$touchScrollingSub = null),
                  this.menuScrollRefreshData(i),
                  t.extend(a, {
                    touchStartY: o.pageY,
        ...
        menuShow: function (t) {
          if (
            ...
            if (((this.opts.keepHighlighted || this.isCollapsible()) && i.addClass("highlighted"), this.isCollapsible()))
